...
Write-Host ""
Write-Host "To deploy remote agents, use:" -ForegroundColor Yellow
Write-Host "  ./deploy-remote-agent.ps1 -AgentName azurefoundry_fraud -Port 9004" -ForegroundColor White
Write-Host ""
